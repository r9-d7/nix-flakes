{
  ...
  xdg.configFile."hypr/monitors.conf".source = ../../dotfiles/hyprland/desktop/.config/hypr/monitors.conf;
  ...
  #waybar
  xdg.configFile."waybar/config.jsonc".source = ../../dotfiles/waybar/desktop/.config/waybar/config.jsonc;
  xdg.configFile."waybar/mocha.css".source = ../../dotfiles/waybar/.config/waybar/mocha.css;
  xdg.configFile."waybar/style.css".source = ../../dotfiles/waybar/desktop/.config/waybar/style.css;
